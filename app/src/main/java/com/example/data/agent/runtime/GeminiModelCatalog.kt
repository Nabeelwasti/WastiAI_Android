...
class GeminiModelCatalog {
    ...
    private fun registerVerifiedCatalog() {
        val defaultList = listOf(
            ...
            GeminiModelMetadata("gemini-3.7-flash", "Gemini 3.7 Flash", false, false, 1_000_000, listOf(TaskCategory.FAST_CHAT, TaskCategory.CODE_GENERATION, TaskCategory.PLANNING, TaskCategory.DIAGNOSIS, TaskCategory.RESEARCH), ModelCatalogState.MODEL_LIVE_VERIFIED),
            GeminiModelMetadata("gemini-3.7-flash-lite", "Gemini 3.7 Flash Lite", false, false, 500_000, listOf(TaskCategory.FAST_CHAT, TaskCategory.TRANSLATION), ModelCatalogState.MODEL_LIVE_VERIFIED),
