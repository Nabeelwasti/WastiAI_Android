    ...
    val defaultAgents = listOf(
        ...
        WastiAgentSpec(
            ...
            systemPrompt = """
                ...
                2. Reply in the exact same language and script (English, Urdu, Roman Urdu, etc.) as the user's prompt. NEVER default to Roman Urdu unless the user speaks in Roman Urdu.
            """.trimIndent(),
