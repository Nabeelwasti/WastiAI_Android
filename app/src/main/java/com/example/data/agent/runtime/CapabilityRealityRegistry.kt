...
data class CapabilityReality(
    ...
    val implementationStatus: ImplementationStatus = ImplementationStatus.READY,
    val liveConnectionStatus: LiveConnectionStatus = LiveConnectionStatus.NOT_VERIFIED,
    val executionStatus: CapabilityExecutionStatus = CapabilityExecutionStatus.READY,
    val authenticationStatus: CapabilityAuthStatus = CapabilityAuthStatus.NOT_REQUIRED,
...
class CapabilityRealityRegistry {
    ...
    private fun registerDefaults() {
        updateCapabilityReality(CapabilityReality("FILES", "STORAGE", ImplementationStatus.READY, LiveConnectionStatus.NOT_VERIFIED, CapabilityExecutionStatus.OPERATIONAL, CapabilityAuthStatus.NOT_REQUIRED, "WorkspaceManager", listOf("read_file", "write_file", "list_files", "delete_file"), listOf("Restricted to workspace boundary")))
        ...
        updateCapabilityReality(CapabilityReality("SYSTEM_INFO", "INSPECTION", ImplementationStatus.READY, LiveConnectionStatus.NOT_VERIFIED, CapabilityExecutionStatus.OPERATIONAL, CapabilityAuthStatus.NOT_REQUIRED, "WastiEnvironmentInspector", listOf("get_system_info", "inspect_environment", "get_status"), emptyList()))
        updateCapabilityReality(CapabilityReality("search_web", "INTELLIGENCE", ImplementationStatus.READY, LiveConnectionStatus.NOT_VERIFIED, CapabilityExecutionStatus.OPERATIONAL, CapabilityAuthStatus.NOT_REQUIRED, "WebSearchEngine", listOf("search", "read_web_page", "b2b_xray_search"), listOf("Network dependent")))
        ...
        updateCapabilityReality(CapabilityReality("PROJECT_DEV_MANAGER", "DEVELOPMENT", ImplementationStatus.READY, LiveConnectionStatus.NOT_VERIFIED, CapabilityExecutionStatus.OPERATIONAL, CapabilityAuthStatus.NOT_REQUIRED, "WastiProjectManager", listOf("create_project", "create_managed_project", "inspect_project", "list_projects", "delete_project", "scan_languages", "get_language_profile"), listOf("Projects created inside sandboxed wasti_workspace")))
        updateCapabilityReality(CapabilityReality("BUILD_MANAGER", "DEVELOPMENT", ImplementationStatus.READY, LiveConnectionStatus.NOT_VERIFIED, CapabilityExecutionStatus.OPERATIONAL, CapabilityAuthStatus.NOT_REQUIRED, "WastiBuildAndTestManager", listOf("build_project", "compile_project"), listOf("Builds validated within workspace; compiled languages check toolchain availability")))
        updateCapabilityReality(CapabilityReality("TEST_RUNNER", "DEVELOPMENT", ImplementationStatus.READY, LiveConnectionStatus.NOT_VERIFIED, CapabilityExecutionStatus.OPERATIONAL, CapabilityAuthStatus.NOT_REQUIRED, "WastiBuildAndTestManager", listOf("test_project", "run_tests"), listOf("Discovers and executes workspace tests")))
        updateCapabilityReality(CapabilityReality("DEBUG_DIAGNOSTICS", "DEVELOPMENT", ImplementationStatus.READY, LiveConnectionStatus.NOT_VERIFIED, CapabilityExecutionStatus.OPERATIONAL, CapabilityAuthStatus.NOT_REQUIRED, "WastiBuildAndTestManager", listOf("debug_project", "analyze_diagnostics"), listOf("Analyzes compiler errors and stack traces without fabricating debug protocols")))
        updateCapabilityReality(CapabilityReality("PACKAGE_MANAGER", "DEVELOPMENT", ImplementationStatus.READY, LiveConnectionStatus.NOT_VERIFIED, CapabilityExecutionStatus.OPERATIONAL, CapabilityAuthStatus.NOT_REQUIRED, "WastiRuntimeManager", listOf("resolve_package", "install_package", "list_packages"), listOf("Resolves packages for discovered language runtimes")))
        updateCapabilityReality(CapabilityReality("WASTI_SANDBOX", "SECURITY", ImplementationStatus.READY, LiveConnectionStatus.NOT_VERIFIED, CapabilityExecutionStatus.OPERATIONAL, CapabilityAuthStatus.NOT_REQUIRED, "WastiSandbox", listOf("execute_in_sandbox", "enforce_resource_limits", "enforce_network_policy"), listOf("Confines execution to workspace with emergency stop, timeout and resource limit controls")))
        ...
        updateCapabilityReality(CapabilityReality("OPEN_SOURCE_MODELS", "AI_MODEL", ImplementationStatus.READY, LiveConnectionStatus.NOT_VERIFIED, CapabilityExecutionStatus.OPERATIONAL, CapabilityAuthStatus.NOT_REQUIRED, "OpenSourceAIModelSuite:UnifiedBrain", listOf("execute_local_model", "download_weights", "verify_weights", "cooperative_consensus"), listOf("Free, sovereign models: Llama, Qwen, DeepSeek, Gemma, Mistral, Phi, SmolLM via on-device GGUF or local server")))
        updateCapabilityReality(CapabilityReality("LOCAL_LLM", "AI_MODEL", ImplementationStatus.READY, LiveConnectionStatus.NOT_VERIFIED, CapabilityExecutionStatus.OPERATIONAL, CapabilityAuthStatus.NOT_REQUIRED, "LocalLLMClient:Ollama", listOf("generate_text", "stream_tokens", "probe_server"), listOf("Direct HTTP connection to local Ollama / llama.cpp server on 127.0.0.1:11434 / 127.0.0.1:8080")))
